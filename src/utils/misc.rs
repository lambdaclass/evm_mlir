...
use crate::{
    ...
    constants::{
        ...
        CALLDATA_PTR_GLOBAL, CALLDATA_SIZE_GLOBAL, GAS_COUNTER_GLOBAL, MEMORY_PTR_GLOBAL,
        MEMORY_SIZE_GLOBAL,
    },
    env::AccessList,
    errors::CodegenError,
    ...
    utils::gas::{consume_gas, consume_gas_as_value},
};

use super::{gas::get_remaining_gas, llvm_mlir, stack::stack_pop};
