...
fn eip3855_push0_ors_store() {
    ...
    let ors = vec![Operation::Or; MAX_STACK_SIZE - 1];
    let program = vec![
        pushs,
        ors,
        vec![
...
#[test]
fn eip3855_push0_gas_cost() {
    let program = vec![Operation::Push0, Operation::Push0, Operation::Push0];
    let used_gas = gas_cost::PUSH0 * 3;
